package br.com.ifpe.meraki.config;
...
import br.com.ifpe.meraki.seguranca.jwt.JwtAuthenticationEntryPoint;
import br.com.ifpe.meraki.seguranca.jwt.JwtTokenAuthenticationFilter;
import br.com.ifpe.meraki.seguranca.jwt.JwtTokenProvider;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .anyRequest()
                .hasAnyAuthority(Usuario.ROLE_CLIENTE, Usuario.ROLE_FORNECEDOR, Usuario.ROLE_ADMIN)
                .and().addFilterBefore(
